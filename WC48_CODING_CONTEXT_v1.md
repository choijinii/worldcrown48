...
> 정본 = `LANGUAGE.md` §일일 판 한도(Daily Run Limit) + `outputs/참가규칙_정본v2.1_판Run_2026-09-07.html` — **계정당·대회당 하루(KST) 5판**, 판마다 새 대진표+Crown Card 1장, 게스트 하루 통틀어 3판(v2.1 · 공유 개방 · 저장 잠금 · 게스트의 선택 랭킹 제외). 제품 정의에서 "표"는 단위로 쓰지 않습니다.
...
> 대체된 것: 카테고리·랭킹·브래킷 관련 서술은 대개편 이전 기준. 코드 작업 전 CLAUDE.md v2.2 「대개편」 섹션과 LANGUAGE.md v1.7 §13 필독
