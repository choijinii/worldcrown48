...
| **BannerSlot** | Notice strip under the Arena stage. Two sizes only — `desktop 970×90` · `mobile 320×100`, both page-centred. No banner on mobile landscape or the Round-transition screen. |
