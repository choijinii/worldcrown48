...
| docs/design/WC48_DESIGN_SYSTEM_v2.4.md | 디자인 토큰 단일 진실 |
...
| 4 | AI-Report | 배지: **"✦ AI-Report"** (12px JetBrains Mono, #FCD006). **뉴스 article 푸터에만** 등장 — 카드·배너·박스 어디에도 표시 금지. 폐기: "AI GENERATED" + 구버전 "● AI-Report" 카드 byline (2026-05-31 갱신) |
