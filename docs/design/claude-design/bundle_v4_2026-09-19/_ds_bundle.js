/* @ds-bundle: {"format":4,"namespace":"WorldCrown48DesignSystem_ea92b8","components":[{"name":"AIReportFooter","sourcePath":"components/AIReportFooter/AIReportFooter.jsx"},{"name":"Button","sourcePath":"components/Button/Button.jsx"},{"name":"StatusPill","sourcePath":"components/StatusPill/StatusPill.jsx"},{"name":"TournamentCard","sourcePath":"components/TournamentCard/TournamentCard.jsx"},{"name":"VSBattle","sourcePath":"components/VSBattle/VSBattle.jsx"}],"sourceHashes":{"components/AIReportFooter/AIReportFooter.jsx":"5ecd21d9b5d8","components/Button/Button.jsx":"c39d3446b1fe","components/StatusPill/StatusPill.jsx":"74bee5be0d33","components/TournamentCard/TournamentCard.jsx":"d04e99abd10c","components/VSBattle/VSBattle.jsx":"b360916d4646","ds/app.jsx":"ed1c5e1061a2","ds/sec-brand.jsx":"37c32dfec61a","ds/sec-cinematic.jsx":"b43434ab4bcb","ds/sec-components.jsx":"fb30086867db","ds/sec-foundation.jsx":"9c3241fa0193","ds/sec-rules.jsx":"c63d4eb9c99b","ds/widgets.jsx":"42aa4203d3e0","ui_kits/web/App.jsx":"b820510db793","ui_kits/web/Arena.jsx":"495c586c4d8f","ui_kits/web/CrownReveal.jsx":"362fb36d2ba2","ui_kits/web/LaunchPad.jsx":"8faaa67dd379","ui_kits/web/Pitch.jsx":"60c8ad06d547","ui_kits/web/components.jsx":"7b5b05ca675a","ui_kits/web/data.jsx":"5207a54b74c2"},"inlinedExternals":[],"unexposedExports":[]} */
...
function VSBattle({
  ...
  }, "PICK ", side.toUpperCase()), /*#__PURE__*/React.createElement("span", {
    style: {
      marginTop: 2
    }
  }, data.name)));
...
function VoteFeedTypewriter() {
  const MSGS = ["Fan #4,812 just picked 미나", "New tournament: Idol of the Decade", "Fans are making their voice heard", "ROUND OF 24 begins for a Fan", "Fan #7,301 claimed their Crown Card", "48 Contestants. One Crown."];
...
function SecCinematic() {
  const steps = [{
    ...
    desc: "One Match at a time. Pure fan choice.",
    bg: "var(--color-bg-deep)"
  }, {
    num: "03",
...
function SecComponents() {
  return /*#__PURE__*/React.createElement(Section, {
    ...
    variant: "gold",
    size: "lg"
  }, "Pick Now"), /*#__PURE__*/React.createElement(MagneticButton, {
    variant: "ghost"
  ...
  }, "Across the past day, fan momentum shifted decisively toward the top seed, with the gap widening to a commanding margin. Fans are making their voice heard across every region."), /*#__PURE__*/React.createElement("span", {
...
function SecFoundation() {
  ...
  }, "Pick your Champion \xB7 \uB204\uAC00 \uC655\uAD00\uC744 \uC4F8\uAE4C"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "var(--font-mono)",
      fontSize: 10.5,
      letterSpacing: "0.18em",
...
function SecRules() {
  ...
  }, "Never put ", /*#__PURE__*/React.createElement("code", null, "ROUND OF 48 \xB7 MATCH 7/24"), " or a progress bar on the VS surface. The Fan is a player, not a spectator."), /*#__PURE__*/React.createElement(Rule, {
    kind: "do",
...
function Arena({
  ...
  return /*#__PURE__*/React.createElement("main", {
    ...
    onClick: () => pick("left")
  }, /*#__PURE__*/React.createElement("small", null, "PICK LEFT"), /*#__PURE__*/React.createElement("span", {
    className: "name"
  }, a.name)), /*#__PURE__*/React.createElement("button", {
    className: "vote-btn vote-btn--right",
    onClick: () => pick("right")
  }, /*#__PURE__*/React.createElement("small", null, "PICK RIGHT"), /*#__PURE__*/React.createElement("span", {
    className: "name"
...
function Pitch({
  ...
  }, "48 Contestants. Five Rounds. The Fan advances Match by Match until one Crown remains."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 14,
      marginBottom: 24
