...
| **버전** | **날짜** | **주요 변경** |
| --- | --- | --- |
| **v2.2** | **2026-09-07** | **★ 참가 규칙 v2.1 전파(게스트 정책, 2026-09-06 대표 확정) + '표' 낱말 금지 승격(2026-09-07 대표 확정).** §2 신규 행 **게스트 일일 판 한도 = 하루 통틀어 3판**(대회 수 무관 고정 · 공유 개방 · 저장 잠금 · 게스트의 선택 랭킹 제외, 소급 없음) · §7 금지어 2행 추가("표" 낱말 자체 → "선택" · "무료 1판" 폐기) · §12 Guest Run에 v2.1 각주. 일일 판 한도 행의 게스트 문장은 새 행을 가리키도록만 수정(로그인 규칙 무변경) |
