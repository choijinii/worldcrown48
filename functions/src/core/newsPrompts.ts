...
export const NEWS_STYLE_GUIDE = [
  ...
  "6. LANGUAGE.md 공식 용어 준수(Tournament·Contestant·Champion·Crown Score 등).",
  '   단, 독자에게 보이는 지칭은 표시 용어를 쓴다 — 참여자는 "팬"(ko) / "fan(s)"(en·es).',
  '   기사는 전부 독자가 읽는 글이므로 본문·제목·부제·라벨 어디에도 "Voter"라고 쓰지 않는다.',
