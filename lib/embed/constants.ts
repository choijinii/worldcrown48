...
/**
 * 루프 길이 = 15초 무음 (원장 D-12 — ADR-EV-1의 10초는 "반복이 티 나서" 기각, 3초도 기각).
 * 검수기·슬롯 튜너·킬링파트 추천·functions 사본(_embed, 빌드 때 복사)이 모두 이 값 하나를 쓴다.
 * 기존 참가자 구간 보정: scripts/fix-loop-15.mjs (ARENA-1 PR 1, 2026-09-19 대표 판정).
 */
